...
2. Create from template:
   ...
   cp ~/repos/dump/second-brain/_templates/topic.md ~/repos/dump/second-brain/topics/<topic>/README.md
   ```
...
4. Add to topic index in ~/repos/dump/second-brain/README.md
...
```bash
# Search index
grep -i "<query>" ~/repos/dump/second-brain/README.md
