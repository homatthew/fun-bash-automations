...
Use normal project-local discovery by default. If the user has configured a
shared database through `BD_DB`, honor it without inventing or hard-coding a
machine-specific path. Use `repo:<name>` labels when a shared database needs
