...
case "${1:-} ${2:-}" in
  ...
  "agent focus"|"tab focus"|"pane label"|"agent start") ;;
  *) exit 2 ;;
esac
FAKE
...
helpers=(
  herdr-close-pane herdr-confirm-close-pane herdr-confirm-close-tab
...
printf '%s\n' '{"pane_id":"old","tab_id":"w1:t1","workspace_id":"w1","cwd":"/tmp","label":"Kimi","agent":"kimi","session_kind":"id","session_value":"kimi-session","parent":null}' \
